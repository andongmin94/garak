...
Steinberg::FUnknown* GainController::create_instance(void*) {
  return static_cast<Steinberg::Vst::IEditController*>(new GainController());
}
...
Steinberg::tresult PLUGIN_API GainController::initialize(Steinberg::FUnknown* const context) {
  ...
  auto* const gain = new Steinberg::Vst::RangeParameter(
      ...
      garak::spike::gain::kMaximumDecibels, garak::spike::gain::kDefaultDecibels, 0,
