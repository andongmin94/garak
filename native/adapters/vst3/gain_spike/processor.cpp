...
GainProcessor::GainProcessor() noexcept {
  setControllerClass(controller_fuid());
  const garak::spike::gain::SpikeState defaults{garak::spike::gain::default_normalized_gain(),
                                                false};
...
Steinberg::FUnknown* GainProcessor::create_instance(void*) {
