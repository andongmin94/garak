...
inline constexpr std::array<std::uint8_t, 16> kInvertedProductId{
    0xD1, 0x33, 0x18, 0x06, 0x9A, 0xE0, 0x49, 0x71, 0xB8, 0x3F, 0x87, 0x1D, 0x4A, 0xF6, 0x77, 0xB5};
inline constexpr std::array<std::uint8_t, 16> kInvertedProcessorFuid{
    0x0F, 0x94, 0x40, 0x08, 0x2C, 0xB4, 0x4B, 0x25, 0x20, 0xD7, 0x48, 0x08, 0xAB, 0xBE, 0x9B, 0xB7};
